...
def web_scraping_table():
    ...
    for tabela in tabelas:
        ...
        lst_titulo = [
            tabela.find_element(
                By.XPATH, f'//*[@id="divContainerIframeBmf"]/div[2]/div/table[{i}]/caption').text
            for i in range(1, 35)
        ]
        ...
        lst_colunas = [
            tabela.find_element(
                By.XPATH, f'//*[@id="divContainerIframeBmf"]/div[2]/div/table[{posicao_dol_xpath}]/thead/tr[1]/th[{i}]').text
            for i in [2, 3]
        ]
